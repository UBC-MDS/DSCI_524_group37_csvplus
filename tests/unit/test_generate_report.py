...
class TestNumericColumns:
    ...
    def test_numeric_missing_values(self):
    ...
    def test_integer_and_float_dtypes(self):
    ...
    def test_quartile_calculations(self):
...
class TestCategoricalColumns:
    ...
    def test_top_values_custom_n(self):
        """Test that 'top_values' returns the correct value
    ...
    def test_string_and_object_dtypes(self):
...
class TestMixedDataFrame:
    """Test DataFrames with mixed column types."""
...
class TestEdgeCases:
    ...
    def test_extreme_unique_values(self):
    ...
    def test_all_columns_all_null(self):
    ...
    def test_duplicate_values_in_categorical(self):
